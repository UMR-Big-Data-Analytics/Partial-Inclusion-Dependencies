...
%    \boldNumberSetsfalse % Use this value if you want variables for number sets (like N or R) to appear in blackboard bold rather than bold.
    ...
    \dateOfHandingIn{20. Januar 2024}
    ...
    \mySubject{Partial Inclusion Dependency Discovery}
...
\begin{document}
    ...
    \chapter{Related Work}\label{cha:rel_work}
    \input{1_Foundations/related_work}
    
    % \part{Results}
    \input{3_Results/Datasets}

    \chapter{Proposals}
    \input{4_Proposals/proposals}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

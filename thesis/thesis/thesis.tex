...
%    \boldNumberSetsfalse % Use this value if you want variables for number sets (like N or R) to appear in blackboard bold rather than bold.
    ...
    \myTitle{Partial Inclusion Dependency Discovery}{Findung parieller Inklusionsabhängigkeiten}
...
\begin{document}
    ...
    \section{Definitions}
    \input{1_Foundations/definitions}
        
    \section{Technologies}
    \input{1_Foundations/technologies}
    
    \section{Null Entries}
    \input{1_Foundations/dealing_with_null}

    \chapter{Related Work}
    \input{1_Foundations/related_work}

    \part{Partial Inclusion Dependencies}
    
    \include{2_Partial Inclusion Dependencies/pSpider}
    
    \include{2_Partial Inclusion Dependencies/candidate_generation}
    
    \include{2_Partial Inclusion Dependencies/pBinder}

    \include{2_Partial Inclusion Dependencies/spind}

    \part{Results}
    \section{Data Sets}
    \include{3_Results/Datasets}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
